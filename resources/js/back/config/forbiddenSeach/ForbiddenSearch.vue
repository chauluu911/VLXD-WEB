                    ...
                    <b-row class="mb-3">
                        <b-col class="text-right" style="min-width: 300px;">
                            ...
                            >
                                ...
                                <template #default>
                                    {{ $t('common.button.add2', {objectName: 'từ khóa'}) }}
                                </template>
                            </a-button>
                        </b-col>
                    </b-row>
...
<script>
    ...
    import packageListManage from "../../../locales/back/config/forbidden_search";
    ...
    export default {
        ...
        computed: {
            ...
            fields() {
                return [
                    ...
                    {label: 'Từ khóa', key: 'name', thClass: 'text-center align-middle', tdClass: 'col-text', colWidth: '75%'},
        ...
        created() {
            ...
            this.$store.commit('updateBreadcrumbsState', [
                {
                    text: 'Cấu hình từ khóa bị cấm tìm kiếm',
                    to: { name: 'config.forbidden_search' }
                }
            ]);
            //this.getData();
