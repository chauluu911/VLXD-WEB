		...
		<div class="row m-0 justify-content-center" v-cloak>
			<div class="col-lg-16 col-md-24">
				...
				<div class="row form-login bg-white my-4 pt-4" style="box-shadow: 1px 1px 5px 1px #E0E0E0">
                    <div v-if="stage === ELoginStage.VERIFY_OTP_FORGOT_PASSWORD" class="w-100 pr-1 ">
                        <div class="col-48 text-right px-1">
                            <a href="javascript:void(0)" class="text-black text-decoration-none" data-dismiss="modal"
                               @click="backToForgotPasswordEmail">
				    ...
				    <div class="col-48 py-3">
				        <div class="row">
				            ...
				            <div class="col-md-48" v-for="field in formFields">
				                ...
				                <template v-if="time != null && stage == ELoginStage.VERIFY_OTP_FORGOT_PASSWORD">
					                <div class="col-48 text-center mb-2" v-if="time != 0">
					                    Thời gian chờ xác thực: <span class="text-primary">@{{time}}</span>
					                </div>
					                <div v-else class="col-48 text-center mb-2">
					                    <a
